...
public class SignIn_Amazon2 extends Utility {  //This file is the runner file of Home.java and SignInPage.java class of Page Object Model
  ...
  public void f() {
	  ...
	  acc.repass_();
	  acc.cont_();	  
	  System.out.println("Priority_2 is executing,File-2");
	  }
	...
	@Test(priority=1)
  	public void verify() throws IOException {
  	  ...
  	  System.out.println("This is after assertion. Priority_1,File-2");
  	  soft.assertAll();
  	} 
